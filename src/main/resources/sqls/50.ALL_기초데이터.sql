...
VALUES ('hansehee-grid', '실습용 그리드', '/jsp/hansehee/hansehee-grid.jsp', '_self', 'Y', 'Y', 'Y');
-- 메뉴 생성
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (501, 'SYSTEM_MANAGER', '실습용 그리드', '{"ko":"실습용 그리드","en":"실습용 그리드"}',  500, 1, 1, 'hansehee-grid', sysdate(), 'system', sysdate(), 'system');
-- 메뉴 권한
